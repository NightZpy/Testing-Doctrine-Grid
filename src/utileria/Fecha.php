...
class Fecha {
    ...
    public static function fechaToDia($fecha){
    ...
    public static function fechaSiguiente($fecha) {
    ...
    public static function fechaAnterior($fecha) {
    ...
    public static function compararFecha($fecha1, $fecha2) {
    ...
    public static function diaValido($fecha) {
        return ($this->fechaToDia($fecha) != "Sabado" && $this->fechaToDia($fecha) != "Domingo");
    }

    public static function fechaToArray($fecha) {
        if(Fecha::esFormatoValido($fecha))
        {
                return (Fecha::isMySqlFormat($fecha) ? preg_split("[".'-'."]", $fecha, NULL, PREG_SPLIT_NO_EMPTY) : preg_split("[".'/'."]", $fecha, NULL, PREG_SPLIT_NO_EMPTY));
        }
        return NULL;
    }

    //Métodos utiles par manejar horas
    public static function compararHora($tiempo1, $tiempo2) {
    ...
    public static function horaEntre($tiempo, $tiempoInicio, $tiempoFin){
    ...
    public static function difEntreHoras($hora1, $hora2) {
        $convertir = new Convertir();
    ...
    public static function minDifEntreHoras($hora1, $hora2) {
        $convertir = new Convertir();
        $tiempo1Array = $this->horaToArray($hora1);
        $tiempo2Array = $this->horaToArray($hora2);
    ...
    public static function segDifEntreHoras($hora1, $hora2) {
        $convertir = new Convertir();
        $tiempo1Array = $this->horaToArray($hora1);
        $tiempo2Array = $this->horaToArray($hora2);
    ...
    public static function horaToArray($hora) {
    ...
    public static function mesAnno() {
    ...
    public static function hora24ToAmPm($hora)
    {
        return date("g:i a",strtotime($hora));
    }

    public static function horaAmPmTo24($hora) {
    ...
    public static function getHora24() {
        return ($this->hora = date("H"));
    }

    public static function getHora12() {
        return ($this->hora = date("h"));
    }

    public static function getAmPm() {
        return ($this->UTC = date("A"));
    }

    public static function fechaCompletaEs($s) {
        return date("d".$s."m".$s."Y");
    }

    public static function fechaCompletaInt($s) {
        return date("Y".$s."m".$s."d");
    }

    public static function horaCompleta24() {
        return gmdate("H:i:s", time()+($this->GMT*3600));
    }

    public static function horaCompleta12() {
