...
Doctrine_Manager::getInstance()->bindComponent('MediosLaborales', 'doctrine');
 ...
 */
abstract class BaseMediosLaborales extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('medios_laborales');
