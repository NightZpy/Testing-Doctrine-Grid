...
Doctrine_Manager::getInstance()->bindComponent('TiposPersonal', 'doctrine');
 ...
 */
abstract class BaseTiposPersonal extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('tipos_personal');
